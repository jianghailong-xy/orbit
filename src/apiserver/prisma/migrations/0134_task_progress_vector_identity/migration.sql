...
--
-- Migration 0132 gave a decision seven counters and a place to keep them. Two shapes from §0 still
...
-- alternative is a recovery that reports every pre-0134 task as corrupt.
...
-- ---------------------------------------------------------------------------------------------
-- Same rule as 0132's: all of them present, numeric and non-negative. A missing key reads as NULL
...
-- task update, by design (0132's `record` order). So the trigger enforces the property it can
