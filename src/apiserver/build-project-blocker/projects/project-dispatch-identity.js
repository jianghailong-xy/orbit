...
exports.dispatchDesiredSessionId = dispatchDesiredSessionId;
exports.dispatchRuntimeSessionId = dispatchRuntimeSessionId;
 ...
 */
function dispatchDesiredSessionId(idempotencyKey) {
 ...
 */
function dispatchRuntimeSessionId(idempotencyKey) {
    return derivedUuid(`pc:v1:dispatch:runtime-session:${idempotencyKey}`);
}
function derivedUuid(name) {
    const bytes = (0, node_crypto_1.createHash)('sha256').update(name).digest().subarray(0, 16);
...
//# sourceMappingURL=project-dispatch-identity.js.map