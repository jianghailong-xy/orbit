...
exports.LOCK_ORDER_COMPATIBLE = exports.LOCK_ORDER_EXCEPTIONS = exports.LOCK_ORDER = void 0;
exports.orderedIds = orderedIds;
exports.lockOwnerTaskGraph = lockOwnerTaskGraph;
exports.lockCreatorSessions = lockCreatorSessions;
exports.lockTaskLists = lockTaskLists;
exports.creatorSessionsOf = creatorSessionsOf;
/**
...
exports.LOCK_ORDER = [
    ...
    },
    {
        ...
        why: 'Above `task` because that is the order the Project authorization adapter already declares ' +
    ...
    },
    {
        ...
        why: 'The dispatch version boundary for one Task\'s prerequisite set, and the last lock anybody ' +
 ...
 */
exports.LOCK_ORDER_EXCEPTIONS = [
    {
        where: 'TasksService.deleteAndStopRuns — task (50) before the cascade\'s session write (30)',
        why: 'The task rows must be locked before the runs attached to them are read, or a dispatch ' +
    ...
    },
    {
        ...
        why: 'An outbox insert takes FOR KEY SHARE on the project through project_event_project_id_fkey, ' +
 ...
 */
exports.LOCK_ORDER_COMPATIBLE = [
    {
        relation: 'workspace',
        why: 'WorkspacesService.remove takes FOR UPDATE on the row and then waits for nothing — its only ' +
    ...
    {
        relation: 'runner',
        why: 'Nothing in these paths takes FOR UPDATE on a runner row. Heartbeats write it (FOR NO KEY ' +
    ...
    },
    {
        ...
        why: 'Child rows only. They are inserted or updated by the transaction that already holds their ' +
 ...
 */
async function lockOwnerTaskGraph(tx, ownerId) {
 ...
 */
async function lockCreatorSessions(tx, sessionIds) {
 ...
 */
async function lockTaskLists(tx, listIds) {
 ...
 */
async function creatorSessionsOf(tx, taskIds) {
...
//# sourceMappingURL=lock-order.js.map