...
exports.notNoiseSql = void 0;
exports.isNoiseSystemEvent = isNoiseSystemEvent;
 ...
 */
function isNoiseSystemEvent(e) {
    if (e.type !== shared_1.RunEventType.SYSTEM)
        return false;
    const p = e.payload;
    if (!p || typeof p !== 'object')
        return true; // an empty system event says nothing at all
    const record = p;
    const subtype = record.subtype;
    if (typeof subtype === 'string' && MEANINGFUL_SYSTEM_SUBTYPES.has(subtype))
        return false;
