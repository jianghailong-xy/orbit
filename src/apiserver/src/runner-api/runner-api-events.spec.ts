...
function makeController(
  ...
  return {
    calls,
    published: () => published,
    controller: new RunnerApiController(prisma as never, {} as never, realtime as never, {} as never, {} as never, {} as never, {} as never),
  };
}
...
function makeReaderController(rows: unknown[], assignedRunnerId = 'runner-1') {
  ...
  return new RunnerApiController(prisma as never, {} as never, {} as never, {} as never, {} as never, {} as never, {} as never);
}
