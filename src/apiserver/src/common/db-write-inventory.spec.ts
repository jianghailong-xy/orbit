...
const CALLS_WRITE_FUNCTION = /(?:\bSELECT\s+(?:outcome_(?:register_delivery_binding|record_delivery_attestation|record_delivery_verification)|completion_ack_(?:request|decide)_owner_decision|failure_continuation_(?:sweep|route_claim|ack_wakeup|retry_wakeup|cancel_wakeup))|\bFROM\s+failure_continuation_claim_wakeups)\s*\(/i;
