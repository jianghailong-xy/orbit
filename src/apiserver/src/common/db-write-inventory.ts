...
export const TRANSACTION_PARTICIPANTS: readonly TransactionParticipant[] = [
  ...
  { at: 'projects/project-promotion.service.ts#handBackToOwner', under: 'runnerApi.integrationJobResult through applyPromotionJobResult — the same transaction, for a landing the Automatic setting confirmed that found main moved and landed nothing (M-T12); one UPDATE of the promotion row (rank 60) back to READY, whose card the relay then opens beside it' },
