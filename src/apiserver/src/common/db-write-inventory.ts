...
export const TRIGGER_WRITE_SOURCES: readonly TriggerWriteSource[] = [
  ...
  { table: "project", trigger: "project_acceptance_criteria_fact", event: "AFTER UPDATE OF \"acceptance_criteria\"", kind: "ROW/STATEMENT", since: "0127_project_acceptance_run", takes: ["project_acceptance_audit WRITE", "project_acceptance_run WRITE"] },
