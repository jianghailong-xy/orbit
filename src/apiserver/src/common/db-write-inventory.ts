...
export const TRANSACTION_UNITS: readonly TransactionUnit[] = [
  ...
  },
  {
    ...
    shape: 'TX_RETRIED',
    locks: 'project FOR UPDATE or FOR NO KEY UPDATE depending on what is written (rank 40), then project_acceptance_criterion_definition / project_acceptance_run child rows (rank 60), and finally another write of the already-held project row.',
