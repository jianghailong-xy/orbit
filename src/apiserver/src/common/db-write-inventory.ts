...
export const STATEMENT_UNITS: readonly StatementUnit[] = [
  ...
  { at: "providers/providers.service.ts#createPool", class: "INSERT", statements: 1, note: "One nested create: the pool row and its member rows go in as one Prisma write, atomic with each other. The slug guard and the P2002 re-pick are the ones create's entry describes." },
