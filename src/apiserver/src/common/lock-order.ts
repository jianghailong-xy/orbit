...
export const LOCK_ORDER_COMPATIBLE = [
  ...
  {
    relation: 'run_event, tool_call, conversation_turn, task_comment, task_completion_evidence, task_completion_evidence_idempotency, task_judgment_request, task_executable_judgment_result, attachment',
    why:
