...
export const LOCK_ORDER = [
  ...
  {
    rank: 60,
    relation: 'task_dependency, conversation_turn, run_event, tool_call, attachment, project_event, project_action, project_handoff_approval, project_coordinator_wake',
