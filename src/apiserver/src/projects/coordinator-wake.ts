...
export const COORDINATOR_WAKE_EVENTS = [
  ...
  /**
   * A loosening edit to this project's acceptance criteria is held, waiting on the owner. Nothing
   * builds this fact since 2026-09-10 — the owner's card is drawn from the pending read rather than
