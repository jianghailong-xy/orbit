 ...
 * each one.
 *
 * Seven kinds, fifteen controls. The mapping is many-to-one in both directions on purpose: one
 ...
 * makes it the honest synthetic input for `(c)`. `CRITERIA_DECISION_PENDING` has been in the same
