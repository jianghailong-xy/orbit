...
func cliTaskUpdate(args []string, in io.Reader, out io.Writer) error {
	...
	if err != nil {
		// The server's refusal, exactly as it came back, plus where to read the crossing it names
		// when the refusal is one of the two a --project move can meet.
