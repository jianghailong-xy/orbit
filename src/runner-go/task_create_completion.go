...
const runnerTaskCompletionDeclarationError = "completionCriterion is required for runner task creation because omission would implicitly create EVIDENCE_JUDGMENT; set EXECUTABLE, VERIFICATION, EVIDENCE_JUDGMENT, or OWNER_CONFIRMED explicitly (command, policy, and verifier fields do not replace that declaration)"
