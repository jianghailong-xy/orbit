...
func TestMCPTaskCreateBatchSendsEachItemsParentRef(t *testing.T) {
	...
	res := mcp.callTool("task_create_batch", map[string]interface{}{
		"tasks": []interface{}{
			map[string]interface{}{"title": "epic", "projectId": "proj-1", "ref": "epic"},
			map[string]interface{}{"title": "parse", "projectId": "proj-1", "ref": "parse", "parentRef": "epic"},
			map[string]interface{}{
				"title": "backfill", "projectId": "proj-1", "parentRef": "epic",
				"dependsOnRefs": []interface{}{"parse"},
			},
		},
	})
	if res["isError"] == true {
