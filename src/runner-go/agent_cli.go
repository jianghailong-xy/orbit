...
Reports id, name, workDir, runner and the provider each project last ran on — enough to resolve
an @mention to the --agent-id / --agent-name of 'orbit session create'.
`,
...
// The safe workspace write fields, in MCP's own spelling.
