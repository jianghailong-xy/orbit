...
// overrides the account (CODEX_HOME, CODEX_API_KEY, OPENAI_*) only reaches the probe through its
// rolling rate-limit notifications, and those never create or change a block.
