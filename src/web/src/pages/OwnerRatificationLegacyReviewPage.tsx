...
/** Compatibility surface for project-only links emitted by the earlier actor-surface contract. */
export function OwnerRatificationLegacyReviewPage() {
  ...
  const decide = useMutation({
    ...
    onSuccess: async () => {
      await Promise.all([
        ...
        queryClient.invalidateQueries({ queryKey: ['project-acceptance'] }),
      ]);
      await view.refetch();
    },
  });
