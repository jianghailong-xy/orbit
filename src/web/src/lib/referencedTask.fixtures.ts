/**
 * `<referenced-task>` notes copied verbatim out of this deployment's `run_event` rows — the whole
 * note as `splitRecordedNote` hands it to the view, so what a fixture holds is what a reader saw.
 *
 *   select payload->>'controlPlaneNote' from run_event
...
export const ONE_TASK = `<referenced-task id="34OEE9MQXMEm0h0Ptm1GG">
...
export const NEVER_RAN = `<referenced-task id="349vy0HknpSjHwdwJ31O1">
  标题   P0｜审阅并发布文档与社区基线
  状态   OPEN
  所属   (无列表) · 负责 (未指派)
...
export const TWO_TASKS = `<referenced-task id="34DH29mTc7OQ6AwxAFIJu">
...
export const EIGHT_TASKS = `<referenced-task id="34ONkD7V6aKjyLdHXyimz">
...
export const WITH_BACKGROUND_JOBS = `<referenced-task id="34NPZIL9Hfavd9uqJ8tjD">
