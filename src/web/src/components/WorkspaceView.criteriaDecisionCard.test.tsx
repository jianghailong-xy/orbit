...
beforeEach(() => {
  ...
  apiMock.mockImplementation(((path: string, init?: { method?: string }) => {
    ...
    // Nor has it merged anything, so the conversation draws no record of a merge: the only card in
    // this pane is the one this file is about (contract §3.6's `merged`).
