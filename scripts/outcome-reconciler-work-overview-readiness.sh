...
# then the live read-only checks are performed against the deployment. It starts no task.
set -euo pipefail
...
EVIDENCE_PHASE=POSTDEPLOY_CURRENT_BINDING
...
WORK_OVERVIEW_DEPLOYMENT_TASK_ID=NONE \
