...
OUTCOME_COORDINATOR_MODULE="$COMPILED/outcome-reconciler/outcome-coordinator.js" \
OUTCOME_COORDINATOR_SERVICE_MODULE="$COMPILED/outcome-reconciler/outcome-coordinator.service.js" \
OUTCOME_COORDINATOR_ACTION_MODULE="$COMPILED/outcome-reconciler/action-executor.js" \
