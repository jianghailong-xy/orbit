...
OUTCOME_DELIVERY_MODULE="$COMPILED/outcome-reconciler/delivery-attestation.js" \
OUTCOME_DELIVERY_EVALUATOR_MODULE="$COMPILED/outcome-reconciler/outcome-evaluator.js" \
