...
OUTCOME_WATCHDOG_MODULE="$COMPILED/outcome-watchdog/outcome-watchdog.js" \
OUTCOME_WATCHDOG_EVALUATOR_MODULE="$COMPILED/outcome-reconciler/outcome-evaluator.js" \
